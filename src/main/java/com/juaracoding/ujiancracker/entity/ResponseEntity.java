...
public class ResponseEntity implements Serializable, Parcelable
{
    ...
    public final static Creator<ResponseEntity> CREATOR = new Creator<ResponseEntity>() {


        @SuppressWarnings({
            "unchecked"
        })
        public ResponseEntity createFromParcel(android.os.Parcel in) {
    ...
    ;
    private final static long serialVersionUID = -2109021048904693028L;

    protected ResponseEntity(android.os.Parcel in) {
     ...
     * @param status
     */
    public ResponseEntity(String stdout, String time, Integer memory, Object stderr, String token, Object compileOutput, Object message, Status status) {
        super();
        this.stdout = stdout;
        this.time = time;
        this.memory = memory;
    ...
    public String toString() {
        ...
        sb.append(ResponseEntity.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("stdout");
        sb.append('=');
